...
| `docs/new-relic-analytics-setup.md` | Step-by-step New Relic setup + a specific, reasoned feature-flag configuration + a baseline custom-event taxonomy to build on. |
| `docs/subscription-paywall-pattern.md` | The free-trial/paywall/StoreKit 2 design — usage metering, mid-session cutoff, reinstall-abuse mitigation, and three StoreKit-API false starts distilled into "use this one, skip the other two." |
